...
const UsersPage = () => (
  <div className="bg-white rounded-2xl border border-gray-100 p-10 text-center">
    <div className="w-16 h-16 bg-primaryBlue/10 rounded-2xl flex items-center justify-center mx-auto mb-4">
      <Users size={30} className="text-primaryBlue" />
    </div>
    <h2 className="text-xl font-gilroyBold text-gray-700 mb-2">Users</h2>
    <p className="text-sm text-gray-400 font-gilroyRegular max-w-sm mx-auto">
      Create and manage student accounts and canteen manager accounts.
    </p>
