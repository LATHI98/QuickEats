        ...
        <>
          ...
          {session && (
            <div className="mb-6 bg-blue-50 border border-blue-100 rounded-2xl p-4">
              <div className="flex items-start gap-3 mb-4">
                ...
                <div>
                  <p className="text-blue-900 font-['Gilroy_Heavy']">Part of Group Order</p>
              ...
              {session.paymentMode === 'pay_separately' && session.creator._id === JSON.parse(localStorage.getItem('user')).id && memberStatuses.length > 0 && (
                <div className="mt-2 space-y-2">
                  <p className="text-[10px] uppercase tracking-widest text-blue-400 font-['Gilroy_Heavy'] mb-1">Friends' Readiness</p>
                  <div className="grid grid-cols-2 gap-2">
                    {memberStatuses.map(m => (
                      <div key={m._id} className="flex items-center gap-2 bg-white/50 border border-blue-100/50 rounded-xl px-2 py-1.5">
                        ...
                        <span className="text-[11px] font-['Gilroy_Medium'] text-blue-800 truncate">{m.name}</span>
          ...
          <div className="mb-6">
            <div className="flex items-center gap-2 mb-3">
              ...
              <h3 className="text-sm font-['Gilroy_Heavy'] text-gray-900 uppercase tracking-wider">Pickup Mode</h3>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              ...
              >
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="font-['Gilroy_Heavy'] text-gray-900">Scheduled</span>
                </div>
              ...
              >
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="font-['Gilroy_Heavy'] text-gray-900">Instant Pickup</span>
                </div>
                ...
                return (
                  <div className="space-y-4">
                    ...
                    <button
                      ...
                      disabled={!canPlaceOrder}
                      className="w-full flex items-center justify-center gap-2 bg-orange-500 hover:bg-orange-600 disabled:opacity-50 disabled:cursor-not-allowed text-white py-3.5 rounded-xl font-['Gilroy_Heavy'] transition-all shadow-lg shadow-orange-100"
                    >
                      {placing ? 'Placing...' : (
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[100] flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl w-full max-w-sm overflow-hidden shadow-2xl animate-in fade-in zoom-in duration-200">
            <div className="bg-orange-500 p-6 text-white">
              ...
              <h3 className="text-xl font-['Gilroy_Heavy']">Place Group Order?</h3>
            ...
            <div className="p-6 space-y-4">
              ...
              >
                <div className="flex items-center justify-between mb-1">
                  <span className="font-['Gilroy_Heavy'] text-orange-600">Submit for Everyone</span>
              ...
              >
                <span className="font-['Gilroy_Heavy'] text-gray-700 block mb-1">Place Only My Order</span>
