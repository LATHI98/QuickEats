...
const OrderCard = ({ order, onStatusChange, onVerifyCash, onRejectCash, onVerifyPickup, canManagePayments }) => {
  ...
  return (
    <div className="bg-white border border-gray-100 rounded-2xl p-4 shadow-sm">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        {cfg.next
          .filter(next => {
            // Force staff to use the modal-based "Mark Delivered" button for ready orders
            if (order.status === 'ready' && next === 'completed') return false;
