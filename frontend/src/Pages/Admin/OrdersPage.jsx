    ...
    <div className="fixed inset-0 z-50 bg-black/40 backdrop-blur-sm flex items-center justify-center p-4" onClick={onClose}>
      ...
      >
        ...
        <div className="sticky top-0 bg-white/80 backdrop-blur-md z-10 flex items-center justify-between p-6 border-b border-gray-100">
          <div>
            <h2 className="text-xl font-['Gilroy_Heavy'] text-gray-900">Queue #{order.queueNumber}</h2>
            <p className="text-xs text-gray-400 mt-1 font-['Gilroy_Medium']">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between bg-gray-50 p-4 rounded-2xl">
              <span className="text-sm font-['Gilroy_Heavy'] text-gray-600">Order Status</span>
              <StatusBadge status={order.status} />
            </div>
            <div className="flex items-center justify-between bg-gray-50 p-4 rounded-2xl">
              <span className="text-sm font-['Gilroy_Heavy'] text-gray-600">Payment Status</span>
              <span className={`px-2.5 py-1 rounded-full text-xs font-['Gilroy_Heavy'] ${paymentCfg.bg} ${paymentCfg.color}`}>
                {paymentCfg.label}
              </span>
            </div>
          </div>
          ...
          <div className="space-y-2">
            <p className="text-xs font-['Gilroy_Heavy'] text-gray-500 uppercase tracking-widest">Student</p>
            <div className="bg-orange-50 border border-orange-100 rounded-2xl p-4">
              <p className="font-['Gilroy_Heavy'] text-gray-900">{order.student?.name || 'Unknown'}</p>
          ...
          {order.status === 'ready' && order.pickupCode && (
            <div className="bg-indigo-50 border border-indigo-100 rounded-2xl p-4 text-center">
              <p className="text-[10px] text-indigo-400 font-['Gilroy_Heavy'] uppercase tracking-wider mb-2">Pickup Code</p>
              <p className="text-4xl tracking-[0.25em] font-['Gilroy_Heavy'] text-indigo-700">{order.pickupCode}</p>
            </div>
          )}

          {/* Order Items */}
          <div className="space-y-2">
            <p className="text-xs font-['Gilroy_Heavy'] text-gray-500 uppercase tracking-widest">Items ({order.items?.length})</p>
            <div className="space-y-2 bg-gray-50 rounded-2xl p-4">
              {order.items?.map((item, i) => (
                <div key={i} className="flex justify-between text-xs">
                  <span className="text-gray-600">{item.name} × {item.quantity}</span>
                  <span className="font-['Gilroy_Heavy'] text-gray-900">
                    LKR {(item.unitPrice * item.quantity).toLocaleString()}
                  </span>
                </div>
              ))}
              <div className="border-t border-gray-200 pt-2 mt-2 flex justify-between font-['Gilroy_Heavy']">
          ...
          {order.activityLogs?.length > 0 && (
            <div className="space-y-2">
              <p className="text-xs font-['Gilroy_Heavy'] text-gray-500 uppercase tracking-widest">Activity History</p>
              <div className="space-y-2 bg-gray-50 rounded-2xl p-4 max-h-40 overflow-y-auto">
                {[...order.activityLogs].reverse().map((log, idx) => (
                  <div key={idx} className="text-xs border-b border-gray-200 last:border-0 pb-2 last:pb-0">
                    <p className="text-gray-700 font-['Gilroy_Medium']">{log.note || log.action}</p>
          ...
          <div className="space-y-2 pt-4 border-t border-gray-100">
                ...
                {cfg.next
                  ...
                  .map(next => (
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-orange-500 hover:bg-orange-600 text-white rounded-2xl text-sm font-['Gilroy_Heavy'] transition-colors"
                    >
            ...
            {cfg.next.includes('cancelled') && (
              <button
                ...
                className="w-full flex items-center justify-center gap-2 px-4 py-3 border-2 border-red-200 text-red-500 hover:bg-red-50 rounded-2xl text-sm font-['Gilroy_Heavy'] transition-colors"
              >
            ...
            {canManagePayments && order.payment?.status === 'pending_verification' && (
              <div className="space-y-2">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-green-500 hover:bg-green-600 text-white rounded-2xl text-sm font-['Gilroy_Heavy'] transition-colors"
                >
            ...
            <button
              onClick={onClose}
              className="w-full px-4 py-3 bg-gray-100 hover:bg-gray-200 text-gray-600 rounded-2xl text-sm font-['Gilroy_Heavy'] transition-colors"
            >
              Close
            </button>
          </div>
    ...
    <div className="fixed inset-0 z-50 bg-black/40 backdrop-blur-[2px] flex items-center justify-center p-4" onClick={onClose}>
      <div className="w-full max-w-md rounded-3xl bg-white border border-gray-100 shadow-2xl p-6" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="flex items-start justify-between mb-4">
          <div>
            <p className="text-xs uppercase tracking-widest text-gray-400 font-['Gilroy_Heavy']">Cash Verification</p>
            <h3 className="text-xl font-['Gilroy_Heavy'] text-gray-900 mt-1">Queue #{order.queueNumber}</h3>
        ...
        <div className="rounded-2xl border border-orange-100 bg-orange-50 px-4 py-3 mb-5 flex items-center justify-between">
          <div>
            ...
            <p className="text-sm font-['Gilroy_Heavy'] text-gray-700">{order.student?.name || 'Unknown'}</p>
          </div>
          <div className="text-right">
            <p className="text-xs text-gray-400">Order Total</p>
            <p className="text-xl font-['Gilroy_Heavy'] text-orange-600">LKR {orderTotal.toLocaleString()}</p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          {/* Amount field */}
          <div>
            <label className="block text-xs uppercase tracking-widest text-gray-500 font-['Gilroy_Heavy'] mb-2">Amount Received (LKR)</label>
            <input
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <label className="block text-xs uppercase tracking-widest text-gray-500 font-['Gilroy_Heavy']">Verification Code</label>
              <span className={`text-xs font-['Gilroy_Heavy'] ${codeStr.length === 6 ? 'text-green-600' : 'text-gray-400'}`}>
          ...
          <div className={`rounded-xl border px-3 py-2.5 flex items-center justify-between ${
            ...
            <p className={`text-base font-['Gilroy_Heavy'] ${isAmountSufficient ? 'text-emerald-700' : 'text-gray-400'}`}>
        ...
        <div className="mt-6 flex gap-2">
          <button
            type="button"
            onClick={onClose}
            className="flex-1 rounded-xl border border-gray-200 py-2.5 text-sm font-['Gilroy_Heavy'] text-gray-600 hover:bg-gray-50"
          >
            Cancel
          </button>
          <button
            ...
            disabled={!canSubmit}
            onClick={onSubmit}
            className="flex-1 rounded-xl bg-green-600 hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed py-2.5 text-sm font-['Gilroy_Heavy'] text-white transition-colors"
          >
            {submitting ? (
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/40 backdrop-blur-[2px] flex items-center justify-center p-4" onClick={onClose}>
      <div className="w-full max-w-md rounded-3xl bg-white border border-gray-100 shadow-2xl p-6" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="flex items-start justify-between mb-4">
          <div>
            <p className="text-xs uppercase tracking-widest text-gray-400 font-['Gilroy_Heavy']">Pickup Verification</p>
            <h3 className="text-xl font-['Gilroy_Heavy'] text-gray-900 mt-1">Queue #{order.queueNumber}</h3>
        ...
        {!hasExpectedCode ? (
          <div className="rounded-2xl bg-amber-50 border border-amber-200 px-4 py-3 mb-4 flex items-start gap-2">
            ...
            <div>
              <p className="text-sm font-['Gilroy_Heavy'] text-amber-700">No Pickup Code Generated</p>
          ...
          <div className="rounded-2xl bg-indigo-50 border border-indigo-100 px-4 py-3 mb-4 flex items-center justify-between">
            <div>
              <p className="text-[10px] uppercase tracking-widest text-indigo-400 font-['Gilroy_Heavy']">Expected Pickup Code</p>
              <p className="text-2xl tracking-[0.2em] font-['Gilroy_Heavy'] text-indigo-700 mt-0.5">{order.pickupCode}</p>
            </div>
        ...
        <div className="p-6">
          <div className="flex items-center justify-between mb-4">
            <label className="text-xs uppercase tracking-widest text-gray-500 font-['Gilroy_Heavy']">Enter 6-Digit Pickup Code</label>
            <button 
              onClick={onOpenScanner}
              className="flex items-center gap-1.5 px-3 py-1.5 bg-indigo-50 text-indigo-600 rounded-lg text-xs font-['Gilroy_Heavy'] hover:bg-indigo-100 transition-colors"
            >
          ...
          <div className="mt-3 flex items-center justify-between">
            ...
            <span className="text-[10px] font-['Gilroy_Heavy'] text-gray-400 uppercase tracking-wider">{inputCode.length}/6 digits</span>
          </div>
        </div>
        ...
        <div className="p-6 pt-0">
          <button
            ...
            disabled={!canSubmit}
            onClick={onSubmit}
            className="w-full rounded-2xl bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed py-4 text-sm font-['Gilroy_Heavy'] text-white shadow-lg shadow-indigo-200 transition-all flex items-center justify-center gap-2"
          >
            {submitting ? (
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/40 backdrop-blur-[2px] flex items-center justify-center p-4" onClick={onClose}>
      <div className="w-full max-w-md rounded-3xl bg-white border border-gray-100 shadow-2xl p-6" onClick={(e) => e.stopPropagation()}>
        <div className="flex items-start justify-between mb-4">
          <div>
            <p className="text-xs uppercase tracking-widest text-red-400 font-['Gilroy_Heavy']">Cancel Order</p>
            <h3 className="text-xl font-['Gilroy_Heavy'] text-gray-900 mt-1">Queue #{order.queueNumber}</h3>
          </div>
          <button onClick={onClose} className="p-1.5 hover:bg-gray-100 rounded-xl transition-colors">
            <X size={16} className="text-gray-400" />
        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            <label className="text-xs uppercase tracking-widest text-gray-500 font-['Gilroy_Heavy']">Reason for Cancellation</label>
        ...
        <div className="mt-5 flex gap-2">
          <button type="button" onClick={onClose} className="flex-1 rounded-xl border border-gray-200 py-2.5 text-sm font-['Gilroy_Heavy'] text-gray-600 hover:bg-gray-50 transition-colors">
            Back
          </button>
          <button
            type="button"
            disabled={!canSubmit}
            onClick={onSubmit}
            className="flex-1 rounded-xl bg-red-500 hover:bg-red-600 disabled:opacity-50 disabled:cursor-not-allowed py-2.5 text-sm font-['Gilroy_Heavy'] text-white transition-colors"
          >
            {submitting ? (
              <span className="flex items-center justify-center gap-2">
                <span className="w-3.5 h-3.5 border-2 border-white border-t-transparent rounded-full animate-spin" />
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/40 backdrop-blur-[2px] flex items-center justify-center p-4" onClick={onClose}>
      <div className="w-full max-w-md rounded-3xl bg-white border border-gray-100 shadow-2xl p-6" onClick={(e) => e.stopPropagation()}>
        <div className="flex items-start justify-between mb-4">
          <div>
            <p className="text-xs uppercase tracking-widest text-red-400 font-['Gilroy_Heavy']">Reject Payment</p>
            <h3 className="text-xl font-['Gilroy_Heavy'] text-gray-900 mt-1">Queue #{order.queueNumber}</h3>
          </div>
          <button onClick={onClose} className="p-1.5 hover:bg-gray-100 rounded-xl transition-colors">
            <X size={16} className="text-gray-400" />
        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            <label className="text-xs uppercase tracking-widest text-gray-500 font-['Gilroy_Heavy']">Rejection Reason</label>
            <span className={`text-xs ${
              trimmed.length > MAX_REASON_LEN ? 'text-red-500' : trimmed.length >= MIN_REASON_LEN ? 'text-green-600' : 'text-gray-400'
            } font-['Gilroy_Heavy']`}>
              {reason.length}/{MAX_REASON_LEN}
    ...
    <div className="fixed inset-0 z-[60] bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
      <div className="w-full max-w-sm bg-white rounded-3xl overflow-hidden shadow-2xl">
        <div className="p-4 border-b border-gray-100 flex items-center justify-between">
          <h3 className="font-['Gilroy_Heavy'] text-gray-900">Scan Order QR</h3>
        ...
        <div className="p-4 bg-gray-50 flex justify-center">
          <button 
            onClick={onClose}
            className="px-6 py-2 text-sm font-['Gilroy_Heavy'] text-gray-600 hover:text-gray-900"
          >
            Cancel Scanning
          </button>
        </div>
    ...
    >
      ...
      {!!order.activityLogs?.length && (
        <div className="mt-3 pt-3 border-t border-gray-100">
          <p className="text-[10px] uppercase tracking-widest text-gray-400 font-['Gilroy_Heavy'] mb-2">Activity</p>
  ...
  return (
    <div className="max-w-5xl mx-auto py-8 px-4">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-3xl font-['Gilroy_Heavy'] text-gray-900">Orders Management</h1>
          ...
          {canteenLoading ? (
            <div className="bg-gradient-to-r from-orange-50 to-white border-2 border-orange-100 rounded-2xl px-6 py-6 shadow-sm">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="font-['Gilroy_Heavy'] text-gray-900">Loading canteens...</p>
            ...
            <div className="bg-red-50 border-2 border-red-200 rounded-2xl px-6 py-6">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-['Gilroy_Heavy'] text-red-900">No Canteens Found</p>
            ...
            <div className="bg-gradient-to-r from-orange-50 to-white border-2 border-orange-200 rounded-2xl px-6 py-5 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  <label className="block text-xs font-['Gilroy_Heavy'] text-orange-700 uppercase tracking-wider mb-2">📍 Select Canteen</label>
                  <select
                    value={localCanteenId}
                    onChange={(e) => setLocalCanteenId(e.target.value)}
                    className="w-full bg-white border-2 border-orange-300 px-4 py-3 rounded-xl text-base text-gray-900 font-['Gilroy_Heavy'] focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent cursor-pointer hover:border-orange-400 transition-colors"
                  >
      ...
      {isAdmin && !canteenId && canteens.length > 0 && (
        <div className="mb-8 bg-blue-50 border-2 border-blue-200 rounded-2xl px-6 py-6">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="font-['Gilroy_Heavy'] text-blue-900">Start by Selecting a Canteen</p>
